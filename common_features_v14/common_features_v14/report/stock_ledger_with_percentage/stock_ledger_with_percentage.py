...
def execute(filters=None):
	...
	total_qty_after_transaction = actual_qty
	for sle in sl_entries:
		total_qty_after_transaction += sle.get('actual_qty', 0)
	...
	for sle in sl_entries:
		...
		consumed_percentage = (abs(sle.actual_qty) / total_qty_after_transaction) * 100
